#!/usr/bin/env python3
"""Build a claude-ltm design paper (Markdown) into an academic PDF via pandoc + tectonic.
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Build a claude-ltm design paper into a PDF.")
