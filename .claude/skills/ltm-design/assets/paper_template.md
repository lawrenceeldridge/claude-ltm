...
<!--
  ...
  Build:   python3 .claude/skills/ltm-design/scripts/build_pdf.py <this-file>.md
  Publish: python3 .claude/skills/ltm-design/scripts/build_pdf.py <this-file>.md --publish
...
instrument: the `ltm eval` harness and precise metric definitions.]
...
```
[Verbatim ltm eval output, with the command and commit.]
```
